...
{
    /// <inheritdoc />
    public partial class Half : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2000, 2041, "Chadwick Boseman", 1 },
                    { 2, 1990, 2022, "Jack Chan", 1 },
                    { 3, 1989, 1997, "Chris Evans", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 2022, "BlackPantherWakandaForEver" },
                    { 2, 2, 2016, "BoboiGhaffor" },
                    { 3, 3, 2015, "SpiderMan" },
                    { 4, 1, 2016, "Panda" }
                });
